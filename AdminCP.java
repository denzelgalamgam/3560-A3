...
public class AdminCP extends javax.swing.JFrame implements TreeSelectionListener
{
   ...
   private UserGroup currentGroup;
    ...
    private void verifyIDs() {
        ...
        // Check for UserGroups if IDs are still valid
        if (isValid) {
            for (UserGroup group : UserGroup.getGroups().values()) {
        ...
        if (isValid) {
            ...
            JOptionPane.showMessageDialog(this, "Invalid ID found: " + invalidId);
        }
    }
